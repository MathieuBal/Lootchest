...
export const CHAPTERS = [
  { id: 'awaken', act: 'I · La Descente', title: "L'Éveil",
    text: "Tu brises le sceau de ton premier coffre. Une lueur ancienne s'en échappe et, dans ton esprit, une voix : « Porte-Clé… le monde t'attend, tout en bas. »",
  ...
  { id: 'bastion', act: 'I · La Descente', title: 'Le Bastion',
    text: "Avec ce que tu remontes des profondeurs, une première pierre est posée à la surface. Le dernier bastion d'Aethel renaît — ton village.",
  ...
  { id: 'devourer', act: 'III · Le Dévoreur', title: 'Face au Dévoreur',
    text: "Le voilà : la gueule qui a avalé mille soleils. Tu n'es qu'un Porte-Clé — mais le dernier, et tu portes la mémoire de toutes tes vies. Lève ton arme.",
