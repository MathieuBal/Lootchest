...
export const MATERIALS = {
  iron: {
    id: 'iron', name: 'Fer', adjective: 'en Fer',
  ...
  bronze: {
    id: 'bronze', name: 'Bronze', adjective: 'en Bronze',
  ...
  bone: {
    id: 'bone', name: 'Os', adjective: 'en Os',
  ...
  steel: {
    id: 'steel', name: 'Acier', adjective: 'en Acier',
  ...
  silver: {
    id: 'silver', name: 'Argent', adjective: 'en Argent',
  ...
  obsidian: {
    id: 'obsidian', name: 'Obsidienne', adjective: 'en Obsidienne',
  ...
  gold: {
    id: 'gold', name: 'Or', adjective: 'en Or',
  ...
  crystal: {
    id: 'crystal', name: 'Cristal', adjective: 'en Cristal',
  ...
  mithril: {
    id: 'mithril', name: 'Mithril', adjective: 'en Mithril',
  ...
  dragonbone: {
    id: 'dragonbone', name: 'Os de Dragon', adjective: 'en Os de Dragon',
