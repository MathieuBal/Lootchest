...
export const FACTIONS = {
  ...
  royal: {
    id: 'royal', name: 'Royal', adjective: { m: 'Royal', f: 'Royale' },
  ...
  infernal: {
    id: 'infernal', name: 'Infernal', adjective: { m: 'Infernal', f: 'Infernale' },
  ...
  sylvan: {
    id: 'sylvan', name: 'Sylvain', adjective: { m: 'Sylvestre', f: 'Sylvestre' },
    weight: 10, minRarityIndex: 1,
  ...
  spectral: {
    id: 'spectral', name: 'Spectral', adjective: { m: 'Spectral', f: 'Spectrale' },
  ...
  bestial: {
    id: 'bestial', name: 'Bestial', adjective: { m: 'Bestial', f: 'Bestiale' },
